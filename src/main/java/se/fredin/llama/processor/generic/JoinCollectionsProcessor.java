 ...
 * a list och maps with key/value={@link String}. We can specify what {@link se.fredin.llama.pojo.Field}(s)<br>
 * in those maps to use as {@link se.fredin.llama.pojo.JoinKey}(s). We can also decide what fields we want and<br>

package se.fredin.llama.jobengine.examples.externallinks;

import org.apache.camel.Exchange;
import org.apache.camel.dataformat.bindy.csv.BindyCsvDataFormat;
import se.fredin.llama.jobengine.examples.externallinks.bean.Item;
import se.fredin.llama.jobengine.examples.externallinks.bean.ItemAsset;
import se.fredin.llama.jobengine.JobengineJob;
import se.fredin.llama.jobengine.task.TaskCall;
...
import static se.fredin.llama.jobengine.utils.JobUtils.file;
...
public class JobRoute extends JobengineJob {
    ...
    public void configure() {
        ...
        from(JobUtils.file(prop(INPUT_DIR), "items.csv"))                             // Read items.csv file from input directory
